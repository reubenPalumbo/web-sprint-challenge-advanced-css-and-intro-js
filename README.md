...
1. How would you describe acessibility on the web to someone new to programming?
   The ability for someone to use your page with them having some kind of restriction to how they can see/hear.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Semantic tags, Scaling Units, Simple contrasting colors.
3. How would you explain the concept of a variable to someone new to programming?
   Like X in math. Its just something with a name, that has something equal to it, when you use that var, it just is a quick way to get the thing you made it equal.
4. What is the purpose of using functions in code?
   Make code DRY, if you want to count the number of words in a string, you can do it when you need it, but if you ever use it more then once, then you would be wasting more time rewriting the code then just calling a function.
